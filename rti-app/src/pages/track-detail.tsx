...
import { ArrowLeft, Clock, CheckCircle2, AlertCircle, FileText, Download, Eye, EyeOff, Timer, Gavel, FileSignature, Bot, ChevronDown, ChevronUp } from "lucide-react";
...
export default function TrackDetailPage() {
  ...
  const [isDetailsExpanded, setIsDetailsExpanded] = useState(app?.status === "pending" || app?.status === "replied");
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-md overflow-hidden">
            ...
            <div className="p-6 md:p-8 border-b border-gray-100">
              ...
              <p className="text-sm text-gray-600 mt-1 capitalize">{app.stateId.replace('-', ' ')}</p>
            </div>
            ...
            <div className="p-6 md:p-8 space-y-8">
              <button 
                ...
                className="w-full flex items-center justify-between text-lg font-bold text-gray-900 border-b border-gray-100 pb-3 hover:text-blue-600 transition-colors"
              >
                <div className="flex items-center gap-2">
                  <FileText size={20} className="text-gray-400" />
                  Original Application Details
                </div>
                {isDetailsExpanded ? <ChevronUp size={20} className="text-gray-400" /> : <ChevronDown size={20} className="text-gray-400" />}
              </button>
              ...
              {isDetailsExpanded && (
                <div className="space-y-8 animate-in slide-in-from-top-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-gray-50/50 rounded-xl border border-gray-200">
                    <div>
                      <p className="text-sm font-bold text-gray-600 mb-1">Filed Date</p>
                      <p className="text-gray-900 font-semibold">{formatDate(app.filedDate)}</p>
                    </div>
                    <div>
                      <p className="text-sm font-bold text-gray-600 mb-1">Expected Reply By (30 Days)</p>
                  ...
                  {/* Problem Summary */}
                  <div>
                    <h2 className="text-sm font-bold text-gray-600 mb-2 uppercase tracking-wider">Your Request Summary</h2>
                ...
                <div className="mt-6 p-5 bg-red-50 border border-red-100 rounded-xl animate-in slide-in-from-top-4">
                  ...
                  {appealSuccess ? (
                    <div className="text-center py-6">
                      ...
                      <p className="text-sm text-gray-600">Your First Appeal has been filed with the Appellate Authority.</p>
                    </div>
                  ) : (
                    <>
                      <div className="mb-4">
                ...
                <div className="mt-6 p-5 bg-indigo-50 border border-indigo-100 rounded-xl animate-in slide-in-from-top-4">
                  ...
                  {secondAppealSuccess ? (
                    <div className="text-center py-6">
                      ...
                      <p className="text-sm text-gray-600">Your Second Appeal has been forwarded to the Information Commission.</p>
                    </div>
                  ) : (
                    <>
                      <div className="mb-4">
